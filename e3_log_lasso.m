...
%%
%   Run Multi task Logistic Elastic-Net
...
function e3_log_lasso(x_train,y_train, x_test,y_test,opts,test_task_num,results_path,weights_path) 

    [W, funcVal] = Logistic_Lasso(x_train, y_train, 1, [opts]);
