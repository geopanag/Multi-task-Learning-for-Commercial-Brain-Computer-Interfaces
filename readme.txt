...
The code pipeline to reproduce the analysis follows the order of the number in the script's title. If two scripts have the same number, either one of them can be run simultaneously. (matlab scripts have e1,e2.. instead of 1,2 ..)
